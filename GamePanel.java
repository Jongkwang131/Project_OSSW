...
public class GamePanel extends JPanel implements ActionListener
{
    ...
    public GamePanel()
    {
		...
		dealer = new Dealer();
        user_name = JOptionPane.showInputDialog("Set user name");
        player = new Player(user_name, 32, "Male");
    ...
    {
        int response = JOptionPane.showConfirmDialog(null, user_name + " has no money. Go out now", "Out of funds", JOptionPane.YES_NO_OPTION);
